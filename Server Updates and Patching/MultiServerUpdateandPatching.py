...
# Perform actions based on the OS type (Linux or Windows)
    if os_type.lower() == 'linux':
        ...
        ssh.connect('linux_server_ip', username='your_username',
                    password='your_password')  # remove username and password
...
# Use Paramiko for Linux servers
        ...
        encoded_ps = f'[System.Net.ServicePointManager]::SecurityProtocol = [System.Net.SecurityProtocolType]::Tls12; ' \ 
                     f'Invoke-Expression (New-Object System.Net.WebClient).DownloadString(' \
                     f'\'https://chocolatey.org/install.ps1\'); choco upgrade all -y '
